...
import { DESTINATION_CITIES } from '@/lib/utils/constants';
import { DUTCH_TESTIMONIALS } from '@/lib/data/testimonials';

export const revalidate = 60;

export const metadata: Metadata = {
  title: 'ALPENYA — Chalets et villas d’exception en France',
  description:
        ...
        <div className="container-app relative pb-16 pt-20 sm:pb-24 sm:pt-28 lg:pt-32">
          <FadeIn>
            <span className="text-eyebrow inline-block rounded-full bg-white/10 px-3 py-1.5 uppercase text-sand-200">
              Chalets & villas — France
            </span>
            <h1 className="mt-5 max-w-3xl text-4xl font-extrabold leading-tight text-white sm:text-display-md lg:text-display-lg">
              Des lieux d’exception pour vos prochains séjours
            </h1>
            <p className="mt-4 max-w-xl text-base text-sand-200 sm:text-lg">
              ALPENYA réunit des chalets de montagne et des villas de prestige sélectionnés
              avec soin. Découvrez les biens, demandez une visite et suivez votre réservation au même endroit.
            </p>
          </FadeIn>
      ...
      <section className="border-y border-ink-100 bg-sand-100/60 py-16 sm:py-20">
        <div className="container-app">
          <FadeIn>
            <SectionHeading
              eyebrow="Témoignages"
             title="Ce que nos clients disent d'ALPENYA"
